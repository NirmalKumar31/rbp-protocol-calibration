...
No cloud account, no credentials, no data download. 1046 numeric assertions are checked
against committed tables, of which **908 belong to this paper** and 136 to an earlier
...
PYTHONPATH=src python scripts/verify.py --local results/tables   # 1046/1046
...
tests/          773 tests, no network or cloud; 2 modules need torch
