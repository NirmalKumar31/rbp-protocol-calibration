...
| Abstract (paste into the form) | abstract of `manuscript/paper.tex`, 287 words, no markup |
...
982 numeric assertions against `config/golden.yaml`, and the number of assertions that ran is
...
2. **Confirm the target venue.** The abstract is cut to 287 words for *Briefings in
