...
3. **The AI-use disclosure needs an author decision before submission, and is deliberately not
...
4. **The historical billing-account ID needs an explicit decision, recorded on the release
