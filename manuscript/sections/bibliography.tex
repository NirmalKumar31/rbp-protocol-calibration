...
M.~Horlacher, G.~Cantini, J.~Hesse, et~al.
...
\bibitem[Tourne et~al.(2026)]{tourne2026}
N.~Tourne, G.~De~Waele, V.~Vermeirssen, and W.~Waegeman.
\newblock How negative sampling shapes the performance of transcription factor binding site
prediction models.
\newblock \emph{Bioinformatics}, 42(2):btag048, 2026.
\newblock \doi{10.1093/bioinformatics/btag048}

\bibitem[Khan et~al.(2021)]{khan2021}
A.~Khan, R.~Riudavets~Puig, P.~Boddie, and A.~Mathelier.
\newblock BiasAway: command-line and web server to generate nucleotide composition-matched DNA
background sequences.
\newblock \emph{Bioinformatics}, 37(11):1607--1609, 2021.
\newblock \doi{10.1093/bioinformatics/btaa928}

\bibitem[Kr\"utzfeldt et~al.(2020)]{krutzfeldt2020}
L.-M. Kr\"utzfeldt, M.~Schubach, and M.~Kircher.
\newblock The impact of different negative training data on regulatory sequence predictions.
\newblock \emph{PLOS ONE}, 15(12):e0237412, 2020.
\newblock \doi{10.1371/journal.pone.0237412}

\bibitem[Cohen-Davidi and Veksler-Lublinsky(2024)]{cohendavidi2024}
E.~Cohen-Davidi and I.~Veksler-Lublinsky.
\newblock Benchmarking the negatives: effect of negative data generation on the classification
of miRNA-mRNA interactions.
\newblock \emph{PLOS Computational Biology}, 20(8):e1012385, 2024.
\newblock \doi{10.1371/journal.pcbi.1012385}
...
\bibitem[Demler et~al.(2012)]{demler2012}
O.~V. Demler, M.~J. Pencina, and R.~B. D'Agostino~Sr.
\newblock Misuse of DeLong test to compare AUCs for nested models.
\newblock \emph{Statistics in Medicine}, 31(23):2577--2587, 2012.
\newblock \doi{10.1002/sim.5328}

\bibitem[Pencina et~al.(2012)]{pencina2012}
M.~J. Pencina, R.~B. D'Agostino~Sr, K.~M. Pencina, A.~C.~J.~W. Janssens, and P.~Greenland.
\newblock Interpreting incremental value of markers added to risk prediction models.
\newblock \emph{American Journal of Epidemiology}, 176(6):473--481, 2012.
\newblock \doi{10.1093/aje/kws207}
...
\bibitem[Pan et~al.(2018)]{pan2018}
X.~Pan, P.~Rijnbeek, J.~Yan, and H.-B. Shen.
\newblock Prediction of RNA-protein sequence and structure binding preferences using deep
convolutional and recurrent neural networks.
\newblock \emph{BMC Genomics}, 19(1):511, 2018.
\newblock \doi{10.1186/s12864-018-4889-1}

\bibitem[Budach and Marsico(2018)]{budach2018}
S.~Budach and A.~Marsico.
\newblock pysster: classification of biological sequences by learning sequence and structure
motifs with convolutional neural networks.
\newblock \emph{Bioinformatics}, 34(17):3035--3037, 2018.
\newblock \doi{10.1093/bioinformatics/bty222}

\bibitem[Gr{\o}nning et~al.(2020)]{gronning2020}
A.~G. B. Gr{\o}nning, T.~K. Doktor, S.~J. Larsen, et~al.
\newblock DeepCLIP: predicting the effect of mutations on protein--RNA binding with deep
learning.
\newblock \emph{Nucleic Acids Research}, 48(13):7099--7118, 2020.
\newblock \doi{10.1093/nar/gkaa530}

\bibitem[Uhl et~al.(2021)]{uhl2021}
M.~Uhl, V.~D. Tran, F.~Heyl, and R.~Backofen.
\newblock RNAProt: an efficient and feature-rich RNA binding protein binding site predictor.
\newblock \emph{GigaScience}, 10(8):giab054, 2021.
\newblock \doi{10.1093/gigascience/giab054}

\bibitem[Pan et~al.(2025)]{pan2025}
X.~Pan, Y.~Fang, X.~Liu, X.~Guo, and H.-B. Shen.
\newblock RBPsuite 2.0: an updated RNA-protein binding site prediction suite with high coverage
on species and proteins based on deep learning.
\newblock \emph{BMC Biology}, 23:74, 2025.
\newblock \doi{10.1186/s12915-025-02182-2}
