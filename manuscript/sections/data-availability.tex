...
% the deposit's own instructions. The VERSION DOI identifies the exact snapshot the reported
% numbers came from, which is what a reproducibility citation needs; the concept DOI resolves
% to whatever the latest version is, so it aids discovery and cannot identify this research
% object. Add the
