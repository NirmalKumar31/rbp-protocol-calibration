...
zero, closing the route removes 96 to 99\% of what the estimator returns and lands within
$5\times10^{-4}$ of the zero theory requires, while for the 4-mer it moves the contribution by
...
harness runs 964 numeric assertions against a frozen expectations file, and the harness asserts
that no
