...
linear predictors on identical rows and folds. The two were compared by DeLong's paired
estimator \citep{delong1988}, in the $O(n\log n)$ midrank form of \citet{sun2014}. The paired estimator is
