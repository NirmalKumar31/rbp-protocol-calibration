...
analogous route. The bias is one-directional, since it can only help the score column, and it
...
estimator returns for such a model is reported in Section~\ref{sec:floor}: it is this channel,
together with the conditioning effect described there, that the floor quantifies.

The two were compared by DeLong's paired
...
no conclusion. This is one of two quantities in the paper that the verification harness
cannot check
