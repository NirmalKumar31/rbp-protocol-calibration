...
content is very nearly a linear functional of the sixteen dinucleotide counts, so a
...
harness runs 923 numeric assertions against a frozen expectations file, and the harness asserts
that no
