...
% THE EXACT ARTICLE TITLE, in the visible title and in the PDF metadata. This carried an
% earlier title that two reviewers had rejected, and the metadata carried a third shortened
% form, so a submission system had three strings for one pair of files.
...
The file \texttt{supplementary\_table\_s1.csv} ships with this document and is committed under
\texttt{results/}\allowbreak\texttt{tables/}. One row per dataset in the 95-dataset candidate
panel, giving the
